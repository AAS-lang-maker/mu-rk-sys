...
ALTER TABLE `user_behavior`
    MODIFY COLUMN `UB_id` INT NOT NULL AUTO_INCREMENT;
INSERT INTO `user_behavior`
(`song_id`, `play_count`, `user_id`, `last_play_time`, `action_type`, `source`)
VALUES
-- 用户 9 (zhangsan): 华语经典粉丝
(1, 45, 9, '2026-04-26 23:00:00', 1, 1), -- App 播放
(2, 30, 9, '2026-04-26 22:30:00', 1, 1),
(3, 1, 9, '2026-04-26 22:00:00', 2, 1), -- 收藏

-- 用户 10 (lisi): 欧美流行乐迷
(10, 52, 10, '2026-04-26 23:40:00', 1, 2), -- Web 播放
(11, 15, 10, '2026-04-26 21:15:00', 1, 2),
(12, 1, 10, '2026-04-25 10:00:00', 3, 1), -- App 下载

-- 用户 17 (xiaoming): 实力派女歌手铁粉
(13, 22, 17, '2026-04-26 20:00:00', 1, 3), -- PC 播放
(14, 18, 17, '2026-04-26 19:45:00', 1, 3),
(15, 1, 17, '2026-04-26 19:30:00', 2, 1), -- App 收藏

-- 用户 12 (xiaochou): 怀旧歌迷（近期不活跃）
(5, 8, 12, '2026-04-20 14:00:00', 1, 1),
(6, 12, 12, '2026-04-19 15:30:00', 1, 1);
INSERT INTO `user_interest_vetor`
(`user_id`, `style_tags`, `last_update_time`)
VALUES
-- 用户 9 (zhangsan): 标签偏向华语流行、经典
(9, '["华语流行", "周杰伦", "经典怀旧", "治愈系"]', '2026-04-26 23:55:00'),

-- 用户 10 (lisi): 标签偏向欧美、电子、节奏感
(10, '["欧美流行", "Taylor Swift", "电子乐", "运动必备"]', '2026-04-26 23:50:00'),

-- 用户 17 (xiaoming): 标签偏向实力派女歌手、灵魂乐
(17, '["灵魂乐", "邓紫棋", "高音控", "现场实录"]', '2026-04-26 23:45:00'),

-- 用户 12 (xiaochou): 标签偏向港台经典、情歌
(12, '["陈奕迅", "粤语经典", "深夜emo", "故事感"]', '2026-04-20 16:00:00');
INSERT INTO `ai_chat_log`
(`user_id`, `message`, `role`, `create_time`, `session_id`)
VALUES
-- Session 1001: 用户 9 (zhangsan) 的对话
(9, '嘿，大豆包，根据我的听歌习惯，推荐几首好听的歌吧！', 'user', '2026-04-26 23:56:00', 1001),
(9, '考虑到你最近单曲循环了 45 次《晴天》，看来你对华语经典情有独衷。我为你推荐陈奕迅的《十年》，这首歌的怀旧氛围和你很搭哦！', 'assistant', '2026-04-26 23:56:05', 1001),
(9, '哇，推荐得真准！再帮我写一份我的听歌报告吧。', 'user', '2026-04-26 23:57:00', 1001),
(9, '没问题！正在为你生成周度听歌报告... 你本周听歌时长超过了 90% 的用户，是一个标准的“杰迷”呢。', 'assistant', '2026-04-26 23:57:10', 1001),

-- Session 1002: 用户 10 (lisi) 的对话
(10, '我想听点带劲的，霉霉有什么歌推荐？', 'user', '2026-04-26 23:45:00', 1002),
(10, '既然你想听带劲的，那绝对不能错过《Shake It Off》！跳起来吧！', 'assistant', '2026-04-26 23:45:05', 1002);
ALTER TABLE `ai_chat_log`
    MODIFY COLUMN `AI_id` INT NOT NULL AUTO_INCREMENT;
